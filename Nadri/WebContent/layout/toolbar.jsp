...
<div class="topbar">
	...
	<div class="collapse navbar-collapse">
		...
		<div class="topmenus">
			<span class="topele">나들이백과</span> <span class="topele">게시판</span> <span
				class="topele">일정작성</span>
		</div>
	</div>
	<div class="toggleBox">
		<img src="/images/common/more_black.png" class="searchOpen">
		<img src="/images/common/search_black.png" class="menuExpand">
	</div>
</div>
