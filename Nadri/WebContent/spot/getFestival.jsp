				...
				<%-- Main content --%>
					<div class="col-lg-12">
							...
							<div class="box-footer">
								<div class="pull-left">
									<button type="button" class="btn btn-default" id="listbutton"><i class="fa fa-list"></i> 목록으로</button>
									<c:if test="${sessionScope.user.userId != null}">
										<div>
										<button type="button" class="btn btn-danger" id="inquirebutton" name="${a.response.body.items.item.contentid}" data-toggle="modal" data-target="#inquireModal"><i class="fa fa-save"></i>신고하기</button>
										<button type="button" class="btn btn-primary" data-toggle='modal' data-target='#cartModal'>장소바구니 추가</button>
										</div>
									</c:if>
									<c:if test="${sessionScope.user.userId == null}">
										<div>
										<button type="button" class="btn btn-danger" id="nologininquire"><i class="fa fa-save"></i>신고하기</button>
										<button type="button" class="btn btn-primary" id="nologincart">장소바구니 추가</button>
										</div>
									</c:if>	
								</div>											
							</div>
	         ...
	         <div class="modal-content">
	            ...
	            <div class="modal-body">
	               <form class="inquire_form">
	                  ...
	                  <span class="reportLink">신 고 링 크<input type="text" name="inquireLink" class="inquireLink" value="${a.response.body.items.item.contentid}">
	                  </span>
	                  <hr />
	                  <div class="count1">
	                     <p class="fonted">제목</p>
