		...
		<table class="table table-hover">
			...
			<div class="container">
				...
				<c:forEach var="festival" items="${a.response.body.items.item}">
					...
					<c:if test="${ !empty festival.firstimage}">
								<!--  값이 있을때 -->
						<div class="col-md-3 col-xs-12" style="padding:10px; dispaly:inline-block;"><img src="${festival.firstimage}"></div>
					</c:if>
					
					<c:if test="${ empty festival.firstimage}">
						<div class="col-md-3 col-xs-12" style="padding:10px; dispaly:inline-block;"><img src="/images/spot/festivaldefault.jpg"></div>
					</c:if>
