...
<!-- 구글맵을 사용하기 위한 CDN -->
<script
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD7-c6GOHSYIeB4RuWDwIbWPdu2oeRTnpI&libraries=geometry,places,drawing"></script>
<!-- 구글맵 매서드가 담긴 주머니 -->
	...
	<form enctype="multipart/form-data" name="updateForm">
		<div id="img"
			...
			<div class="content">
				...
				<button type="button" class="waves-effect waves-light btn"
					id="modalButton">나들이추가</button>
				<button type="button" class="waves-effect waves-light btn"
					id="uploadButton">섬네일변경</button>
			</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group">
							<label for="scheduleTitle">나들이에 제목을 지어주세요</label> <input
								type="text" class="form-control" id="modalscheduleTitle"
								placeholder="제목" value="${schedule.scheduleTitle}">
						</div>
						<div class="form-group">
							<label for="scheduleDetail">주제를 간단히 설명해주세요</label> <input
						...
						<div class="form-group">
							<label for="scheduleDate">언제 나들이 가세요?</label> <input type="text"
								...
								placeholder="나들이가는 날짜를 입력해주세요!!"
								value="${schedule.scheduleDate}" readOnly>
						</div>
					</div>
		...
		<div class="container container-transitU">
			...
			<input type="hidden" name="userId"
				...
				value="${schedule.scheduleTitle}"> <input type="hidden"
				id="scheduleDetail" name="scheduleDetail"
				value="${schedule.scheduleDetail}"> <input type="hidden"
				id="scheduleDate" name="scheduleDate"
				value="${schedule.scheduleDate}"> <input type="hidden"
				id="scheduleImg" name="scheduleImg" value="${schedule.scheduleImg}">
			<input type="hidden" id="scheduleNo" name="scheduleNo"
				value="${schedule.scheduleNo}"> <input type="hidden"
				id="transportationCode" name="transportationCode" value="2">
